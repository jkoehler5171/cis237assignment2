...
I used some of my old code from Dawn's class. I figure if I've written one method to 
print a dimensional array, I've written enough methods to print a dimensional array.
